...
In this paper we generalise the notion of distributional generality based on the proposition of \newcite{Clarke:07} that
...
Given two vectors $x$ and $y$, we can say that $x$ is less than or
